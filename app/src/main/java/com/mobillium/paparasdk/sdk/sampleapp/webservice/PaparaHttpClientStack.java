 ...
 */
public class PaparaHttpClientStack implements HttpStack {
    protected final HttpClient mClient;

    private final static String HEADER_CONTENT_TYPE = "Content-Type";

    public PaparaHttpClientStack(HttpClient client) {
        mClient = client;
    }
...
//                setEntityIfNonEmptyBody(putRequest, request);
    ...
    private static class OwnHttpPut extends HttpPost {
        ...
        public OwnHttpPut(URI uri) {
            super(uri);
        }

        public OwnHttpPut(String uri) {
            super(uri);
        }
